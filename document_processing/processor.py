...
# Импортирование загруженных моделей из models
from .models import task_vectorizer, task_classifier, stopwords, technology_extractor
...
def process_document(url_doc_address):

    # Извлечение ФИО:
    # Загрузка .word документа и преобразование в .txt
    text = docx2txt.process(f'{url_doc_address}')
